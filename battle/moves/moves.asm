...
ENDM
	...
	move VICEGRIP,     EFFECT_NORMAL_HIT,         55, PHYSICAL, NORMAL,   100, 30,   0
	move GUILLOTINE,   EFFECT_OHKO,                0, PHYSICAL, NORMAL,    30,  5,   0
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,         80, SPECIAL,  NORMAL,    75, 10,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, STATUS,   NORMAL,   100, 30,   0
	...
	move FLY,          EFFECT_FLY,                70, PHYSICAL, FLYING,    95, 15,   0
	move BIND,         EFFECT_BIND,               15, PHYSICAL, NORMAL,    75, 20,   0
	move SLAM,         EFFECT_NORMAL_HIT,         80, PHYSICAL, NORMAL,    75, 20,   0
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         35, PHYSICAL, GRASS,    100, 10,   0
	...
	move JUMP_KICK,    EFFECT_JUMP_KICK,          70, PHYSICAL, FIGHTING,  95, 25,   0
	...
	move TACKLE,       EFFECT_NORMAL_HIT,         35, PHYSICAL, NORMAL,    95, 35,   0
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, PHYSICAL, NORMAL,   100, 15,  30
	move WRAP,         EFFECT_BIND,               15, PHYSICAL, NORMAL,    85, 20,   0
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         90, PHYSICAL, NORMAL,    85, 20,   0
	move THRASH,       EFFECT_RAMPAGE,            90, PHYSICAL, NORMAL,   100, 20,   0
	...
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          14, PHYSICAL, BUG,       85, 20,   0
	...
	move DISABLE,      EFFECT_DISABLE,             0, STATUS,   NORMAL,    55, 20,   0
	...
	move LOW_KICK,     EFFECT_FLINCH_HIT,         50, PHYSICAL, FIGHTING,  90, 20,  30
	...
	move ABSORB,       EFFECT_LEECH_HIT,          20, SPECIAL,  GRASS,    100, 20,   0
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          40, SPECIAL,  GRASS,    100, 10,   0
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, STATUS,   GRASS,     90, 10,   0
	move GROWTH,       EFFECT_SP_ATK_UP,           0, STATUS,   NORMAL,   100, 40,   0
	...
	move DIG,          EFFECT_FLY,                60, PHYSICAL, GROUND,   100, 10,   0
	move TOXIC,        EFFECT_TOXIC,               0, STATUS,   POISON,    85, 10,   0
	...
	move MINIMIZE,     EFFECT_EVASION_UP,          0, STATUS,   NORMAL,   100, 20,   0
	...
	move LICK,         EFFECT_PARALYZE_HIT,       20, PHYSICAL, GHOST,    100, 30,  30
	move SMOG,         EFFECT_POISON_HIT,         20, SPECIAL,  POISON,    70, 20,  40
	...
	move WATERFALL,    EFFECT_NORMAL_HIT,         80, PHYSICAL, WATER,    100, 15,   0
	move CLAMP,        EFFECT_BIND,               35, PHYSICAL, WATER,     75, 10,   0
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, SPECIAL,  NORMAL,   100, 20,   0
	move SKULL_BASH,   EFFECT_SKULL_BASH,        100, PHYSICAL, NORMAL,   100, 15,   0
	...
	move KINESIS,      EFFECT_ACCURACY_DOWN,       0, STATUS,   PSYCHIC,   80, 15,   0
	move SOFTBOILED,   EFFECT_HEAL,                0, STATUS,   NORMAL,   100, 10,   0
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,          85, PHYSICAL, FIGHTING,  90, 20,   0
	move GLARE,        EFFECT_PARALYZE,            0, STATUS,   NORMAL,    75, 30,   0
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, SPECIAL,  PSYCHIC,  100, 15,   0
	move POISON_GAS,   EFFECT_POISON,              0, STATUS,   POISON,    55, 40,   0
	move BARRAGE,      EFFECT_MULTI_HIT,          15, PHYSICAL, NORMAL,    85, 20,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          20, PHYSICAL, BUG,      100, 15,   0
	...
	move BUBBLE,       EFFECT_SPEED_DOWN_HIT,     20, SPECIAL,  WATER,    100, 30,  10
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, PHYSICAL, NORMAL,   100, 10,  20
	move SPORE,        EFFECT_SLEEP,               0, STATUS,   GRASS,    100, 15,   0
	move FLASH,        EFFECT_ACCURACY_DOWN,       0, STATUS,   NORMAL,    70, 20,   0
	move PSYWAVE,      EFFECT_PSYWAVE,             1, SPECIAL,  PSYCHIC,   80, 15,   0
	move SPLASH,       EFFECT_SPLASH,              0, STATUS,   NORMAL,   100, 40,   0
	move ACID_ARMOR,   EFFECT_DEFENSE_UP_2,        0, STATUS,   POISON,   100, 40,   0
	move CRABHAMMER,   EFFECT_NORMAL_HIT,         90, PHYSICAL, WATER,     85, 10,   0
...
; New to Gen 2
	...
	move THIEF,        EFFECT_THIEF,              40, PHYSICAL, DARK,     100, 10, 100
	move SPIDER_WEB,   EFFECT_MEAN_LOOK,           0, STATUS,   BUG,      100, 10,   0
	...
	move SNORE,        EFFECT_SNORE,              40, SPECIAL,  NORMAL,   100, 15,  30
	...
	move COTTON_SPORE, EFFECT_SPEED_DOWN_2,        0, STATUS,   GRASS,     85, 40,   0
	...
	move SCARY_FACE,   EFFECT_SPEED_DOWN_2,        0, STATUS,   NORMAL,    90, 10,   0
	move FAINT_ATTACK, EFFECT_ALWAYS_HIT,         60, PHYSICAL, DARK,     100, 20,   0
	move SWEET_KISS,   EFFECT_CONFUSE,             0, STATUS,   NORMAL,    75, 10,   0
	...
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      100, SPECIAL,  ELECTRIC,  50,  5, 100
	...
	move DETECT,       EFFECT_PROTECT,             0, STATUS,   FIGHTING, 100,  5,   0
	move BONE_RUSH,    EFFECT_MULTI_HIT,          25, PHYSICAL, GROUND,    80, 10,   0
	move LOCK_ON,      EFFECT_LOCK_ON,             0, STATUS,   NORMAL,   100,  5,   0
	move OUTRAGE,      EFFECT_RAMPAGE,            90, PHYSICAL, DRAGON,   100, 15,   0
	move SANDSTORM,    EFFECT_SANDSTORM,           0, STATUS,   ROCK,     100, 10,   0
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          60, SPECIAL,  GRASS,    100,  5,   0
	...
	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        10, PHYSICAL, BUG,       95, 20,   0
	...
	move FRUSTRATION,  EFFECT_FRUSTRATION,         1, PHYSICAL, NORMAL,   100, 20,   0
	...
	move PSYCH_UP,     EFFECT_PSYCH_UP,            0, STATUS,   NORMAL,   100, 10,   0
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   20, PHYSICAL, FIGHTING, 100, 15,  50
	move WHIRLPOOL,    EFFECT_BIND,               15, SPECIAL,  WATER,     70, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            10, PHYSICAL, DARK,     100, 10,   0
; New to tppCrystal
