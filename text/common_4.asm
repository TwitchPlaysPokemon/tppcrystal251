...
_SetNuzlockeModeText:
	text "This game can be"
	line "played as a"
	cont "Nuzlocke."

	para "In this game mode,"
	line "you can only catch"

	para "the first #MON"
	line "you encounter in a"
	cont "new area."

	para "If a #MON"
	line "faints, it is dead"
