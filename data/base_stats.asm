...
PhanceroBaseData::
	...
	; tmhm
	tmhm CURSE, ROAR, TOXIC, ROCK_SMASH, PSYCH_UP, HIDDEN_POWER, SNORE, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, GIGA_DRAIN, ENDURE, FRUSTRATION, IRON_TAIL, DRAGONBREATH, RETURN, PSYCHIC, SHADOW_BALL, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, SANDSTORM, SWIFT, DREAM_EATER, DETECT, REST, THIEF, STEEL_WING, NIGHTMARE, FLY, SURF, FLASH, WHIRLPOOL, WATERFALL
	; end
