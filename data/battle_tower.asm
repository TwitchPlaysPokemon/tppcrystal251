Function1f8000: ; 1f8000 generatres mon and trainer and stores them in wram. full structure is, from wd100, 11 bytes of trainer data (name and class), 177 bytes for 3 mons and 36 bytes of ????
...
BTLoop:
	ld de, OTPartyCount
	ld a, [de] 
	ld c, [PartyCount] ;num of mons to generate
	cp c
	jp z, EndBTLoop
StartBTLoop:
...
BattleTowerMons: ; 1f8450
	...
	db MILTANK
	db LEFTOVERS
	db BODY SLAM, EARTHQUAKE, CURSE, MILK_DRINK

	db AIPOM ;5
	db FOCUS_BAND
	db RETURN, DYNAMIC_PUNCH, AGILITY, BATON_PASS
	...
	db VENUSAUR
	db MIRACLE_SEED
	db SEED_BOMB, SLEEP_POWDER, ANCIENT_POWER, SLUDGE
	...
	db BEEDRILL
	db SCOPE_LENS
		db FOCUS_ENERGY, POISON_JAB, TWIN_NEEDLE, DRILL_RUN
	...
	db FEAROW
		db KINGS_ROCK
		db DRILL_PECK, DRILL RUN, TAKE_DOWN, PURSUIT
	...
	db POLIWRATH
	db QUICK_CLAW
	db HYDRO_PUMP, MIND_READER, DYNAMIC_PUNCH, SEISMIC_TOSS
	...
	db GOLEM 
	db QUICK_CLAW
	db EXPLOSION, ROCK SLIDE, DIG, SEISMIC_TOSS
	...
	db HITMONCHAN
	db LEFTOVERS
	db MIND_READER, DYNAMIC_PUNCH, BODY_SLAM, THUNDERPUNCH
	...
	db TANGELA 
	db MYSTERY_BERRY
	db REFLECT, POISON_POWDER, PAIN_SPLIT, GIGA_DRAIN

	db KANGASKHAN ;120
	db PINK_BOW
	db STRENGH, DIZZY_PUNCH/PLAY_ROUGH, FORESIGHT, DYNAMIC_PUNCH
