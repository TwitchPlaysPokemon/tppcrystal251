...
SlugmaEvosAttacks:
	...
	db 37,BODY_SLAM
	db 41,ANCIENTPOWER ; later gen move
	db 45,FIRE_BLAST
	db 50,ROCK_SLIDE
	db 0 ; no more level-up moves
...
StantlerEvosAttacks:
	...
	db 29,TAKE_DOWN
	db 33,PSYCHIC_M ; TM move
	db 37,CONFUSE_RAY
	db 41,BODY_SLAM ; later gen move
	db 45,JUMP_KICK
	db 50,MEGAHORN
	db 55,THUNDER_WAVE
	db 60,HEADBUTT
...
ElekidEvosAttacks:
	...
	db 1,QUICK_ATTACK
	db 3,LEER
	db 6,LOW_KICK ; later gen move
	db 9,THUNDERPUNCH
	db 12,PURSUIT ; event move
	db 15,LIGHT_SCREEN
	db 18,ROLLING_KICK ; egg move
	db 21,SPARK ; illegal move
	db 24,MEDITATE ; egg move
	db 27,FIRE_PUNCH ; tm move
	db 30,SWIFT
	db 33,THUNDERBOLT
