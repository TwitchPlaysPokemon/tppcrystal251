...
PidgeyEvosAttacks:
	...
	db 14,PURSUIT ; egg move
	db 17,AGILITY
	db 20,TAKE_DOWN ; gen 1 move
	db 23,WING_ATTACK
	db 26,STEEL_WING ; tm move
	db 29,WHIRLWIND
	db 32,FAINT_ATTACK ; egg move
	db 35,DOUBLE_EDGE ; gen 1 move
...
PidgeottoEvosAttacks:
	...
	db 1,MUD_SLAP
	db 21,TAKE_DOWN ; gen 1 move
	db 24,WING_ATTACK
	db 28,STEEL_WING ; tm move
	db 31,WHIRLWIND
...
GolbatEvosAttacks:
	...
	db 36, WING_ATTACK ; later gen move
...
GolduckEvosAttacks:
	...
	db 56, TRI_ATTACK ; event move 
	db 61, MEDITATE ; * illegal move
	db 65, WATERFALL ; * hm move
	db 70, MEGA_KICK ; * gen 1 move
	db 75, ZEN_HEADBUTT ; * later gen move
	db 0 ; no more level-up moves
...
StaryuEvosAttacks:
	...
	db 42, PAIN_SPLIT ; later gen move
	db 45, HYDRO_PUMP
	db 0 ; no more level-up moves
...
CrobatEvosAttacks:
	...
	db 1, GUST ; egg move
	db 24, SWIFT ; tm move
	db 27, X_SCISSOR ; * later gen move
	db 30, HAZE
...
QwilfishEvosAttacks:
	...
	db 45, HAZE ; egg move
	db 50, POISON_JAB ; later gen move
	db 55, DESTINY_BOND ; later gen move
	db 60, HYDRO_PUMP
	db 65, EXPLOSION
	db 0 ; no more level-up moves
...
HoundourEvosAttacks:
	...
	db 6, ROAR
	db 9, PURSUIT ; egg move
	db 12, FIRE_SPIN ; egg move
	db 15, SPITE ; egg move
	db 18, BODY_SLAM ; later gen move
	db 21, BITE
	db 25, HEAT_WAVE ; later gen move
...
HoundoomEvosAttacks:
	...
	db 1, BITE
	db 27, HEAT_WAVE ; later gen move
	db 32, COUNTER ; egg move
