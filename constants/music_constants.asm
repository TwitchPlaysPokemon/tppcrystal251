	...
	const MUSIC_CINNIBAR_ISLAND
	const MUSIC_ROUTE_24
	const MUSIC_MART
	const MUSIC_POWER_PLANT
	const MUSIC_SILPH_CO

	const MUSIC_KANTO_LEGEND
	const MUSIC_DPPT_GAME_CORNER
	const MUSIC_LEECH
	const MUSIC_RIVAL_RB
	const MUSIC_RIVAL_AFTER_RB
	const MUSIC_RIVAL_BATTLE_RB
MUSIC_MAHOGANY_MART EQU 100
