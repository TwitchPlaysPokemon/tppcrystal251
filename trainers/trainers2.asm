...
; ================================
	...
	db 74, ALAKAZAM, TWISTEDSPOON
		db FUTURE_SIGHT
		db PSYCHIC
		db REFLECT
		db RECOVER

	db 75, RHYDON, SCOPE_LENS
		db TAKE_DOWN
		db EARTHQUAKE
		db HORN_DRILL
		db SCARY_FACE

	db 75, ARCANINE, CHARCOAL
		db EXTREMESPEED
		db FLAMETHROWER
		db ROAR
		db BITE

	db 75, EXEGGUTOR, MIRACLE_SEED
		db GIGA_DRAIN
		db SEED_BOMB
		db SLEEP_POWDER
		db LIGHT_SCREEN

	db 76, BLASTOISE, MYSTIC_WATER
		db HYDRO_PUMP
		db RAIN_DANCE
		db AQUA_JET
		db BITE
