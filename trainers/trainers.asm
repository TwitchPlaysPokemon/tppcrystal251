...
; ================
	...
	db 73, ELECTRODE, GOLD_BERRY
		db EXPLOSION
		db THUNDER
		db SCREECH
		db DOUBLE_TEAM

	db 74, MAGNETON, METAL_COAT
		db ZAP_CANNON
		db FLASH_CANNON
		db TRI_ATTACK
		db MIND_READER

	db 75, JOLTEON, MAGNET
		db THUNDERBOLT
		db BITE
		db AGILITY
		db MUD_SLAP

	db 76, ELECTABUZZ, LEFTOVERS
		db THUNDER
		db WILD_CHARGE
		db CROSS_CHOP
		db LIGHT_SCREEN
...
; ================
	...
	db 75, XATU, SHARP_BEAK
		db PSYCHIC_M
		db FUTURE_SIGHT
		db DRILL_PECK
		db RECOVER

	db 75, ESPEON ,GOLD_BERRY
		db PSYCHIC_M
		db SWIFT
		db MORNING_SUN
		db SAND_ATTACK

	db 76, JYNX, NEVERMELTICE
		db PSYCHIC_M
		db ICE_BEAM
		db LIGHT_SCREEN
		db LOVELY_KISS
	...
	db 77, MR__MIME, PINK_BOW
		db PSYCHIC_M
		db MOONBLAST
		db BARRIER
		db BATON_PASS

	db 78, ALAKAZAM, TWISTEDSPOON
		db PSYCHIC_M
		db SHADOW_BALL
		db FUTURE_SIGHT
		db RECOVER
