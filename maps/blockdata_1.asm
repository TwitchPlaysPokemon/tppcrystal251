...
VermilionHouseFishingSpeechHouseRB_BlockData:
VermilionMagnetTrainSpeechHouse_BlockData:
VermilionMagnetTrainSpeechHouseRB_BlockData:
VermilionHouseDiglettsCaveSpeechHouse_BlockData:
VermilionHouseDiglettsCaveSpeechHouseRB_BlockData:
