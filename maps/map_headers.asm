...
; pewter city rb
	...
	; map_header PewterMuseumOfScience1F, $5, 3, PEWTER_CITY, MUSIC_VIRIDIAN_CITY, 0, 1, 1
	; map_header PewterMuseumOfScience2F, $5, 3, PEWTER_CITY, MUSIC_VIRIDIAN_CITY, 0, 1, 1
