...
Route2_MapEventHeader: ; 0x1ac4af
	...
	warp_def $27, $f, 3, GROUP_ROUTE_2_GATE, MAP_ROUTE_2_GATE
	...
	warp_def $2b, $3, 1, GROUP_VIRIDIAN_FOREST_GATE_SOUTH, MAP_VIRIDIAN_FOREST_GATE_SOUTH
	...
	; signposts
	db 2
	signpost 65, 5, $0, MapRoute2Signpost0Script
	signpost 11, 11, $0, MapRoute2Signpost1Script

	; people-events
	db 2
	person_event SPRITE_POKE_BALL, 6, 23, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x1ac302, EVENT_ITEM_ROUTE_2_CARBOS
	person_event SPRITE_POKE_BALL, 62, 18, $1, 0, 0, -1, -1, 0, 1, 0, ItemFragment_0x1ac304, EVENT_ITEM_ROUTE_2_ELIXIR
; 0x1ac554
