...
VermilionCityRB_MapEventHeader: ; 0x1aae77
	...
	warp_def 31, 18, 1, GROUP_VERMILION_PORT_PASSAGE_RB, MAP_VERMILION_PORT_PASSAGE_RB
	warp_def 31, 19, 2, GROUP_VERMILION_PORT_PASSAGE_RB, MAP_VERMILION_PORT_PASSAGE_RB
